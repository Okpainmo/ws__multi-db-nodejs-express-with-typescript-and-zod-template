...
A comprehensive WebSocket utility library for managing WebSocket connections, messages, and states in within this template.
...
## Quick Start(Using the helper functions)
